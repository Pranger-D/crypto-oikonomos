...
## [대주제 1 — 수동 자료에서 가장 중요한 논점을 제목으로 직접 결정하세요]
### [소제목 1.1 — 배경과 개념 설명]
이 논점의 배경을 설명하고, 독자가 처음 접한다고 가정하고 핵심 개념을 풀어쓰세요.
개념 설명 → 왜 중요한지 → 오늘 자료와 어떻게 연결되는지 순서로 전개하세요.

### [소제목 1.2 — 심화 분석]
구체적인 수치와 사실을 근거로, 숨겨진 연결고리와 인사이트를 서술하세요.
뉴스 나열 금지. 독자에게 질문을 던져 참여감을 유도하세요.

### [소제목 1.3 — 함의와 확장 (선택)]
이 논점이 더 큰 그림에서 어떤 의미를 갖는지 서술하세요.

## [대주제 2 — 두 번째 핵심 논점 (자료가 충분할 경우만, 선택)]
### [소제목 2.1]
[대주제 1과 같은 방식으로 배경 → 심화 → 함의 순서로 서술]
"""
...
## [대주제 1 — 수동 자료에서 이끌어낸 메타 서사의 제목을 직접 결정하세요]
### [소제목 1.1 — 배경과 개념]
이 대주제를 이해하는 데 필요한 배경과 핵심 개념을 풀어쓰세요.
독자가 처음 듣는다고 가정하고 1~2문장으로 명확히 설명하세요.

### [소제목 1.2 — 핵심 분석]
숨겨진 연결고리를 찾아 메타 서사를 도출하세요. 뉴스 나열 금지.
수치와 사실로 주장을 뒷받침하고, 독자에게 질문을 던지세요.

### [소제목 1.3 — 시사점 (선택)]
이 분석이 투자 철학 혹은 시장 이해에 어떤 시사점을 주는지 서술하세요.

## [대주제 2 — 두 번째 관점 (자료가 충분할 경우만, 선택)]
### [소제목 2.1]
[대주제 1과 같은 방식으로 서술]
...
[개념 설명 규칙]
- 전문 용어, 고유명사, 약어가 처음 등장할 때 독자가 처음 듣는다고 가정하고 1~2문장으로 쉽게 풀어 설명하세요.
- 예: "SOFR(단기 담보부 자금 조달 금리)란 은행들이 서로 달러를 빌릴 때 기준이 되는 금리입니다."
- 개념 설명 → 왜 중요한지 → 오늘 뉴스와 어떻게 연결되는지 순서로 자연스럽게 서술하세요.
- 설명 없이 용어만 던지고 결론으로 직행하지 마세요.

[분량 가이드]
- 본문(Hook~결론)은 최소 5,000자 이상 작성하세요.
- 각 소제목(##, ###) 섹션은 최소 600자 이상 서술하세요.
- 한 문단은 2~3문장으로 짧게 끊되, 문단 수를 충분히 늘려 깊이를 확보하세요.
- 분량 채우기용 반복이나 뻔한 마무리는 금지합니다. 내용의 밀도로 분량을 채우세요.
